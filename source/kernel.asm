;*****************start of the LAJ_OS kernel code***************
[org 0x000]
[bits 16]
...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to LAJ_OS version 1.0.0", 0x00

	wel1 db	'*************************************************', 0x00			

	wel2 db '*********** WELCOME TO LAJ_OS ************', 0x00 
	...
	wel7 db ' version 1.0.0 of LAJ_OS From J.P.L.A Jayasinghe - SE/2019/056', 0x00
	...
	strPrompt		db	"LAJ_OS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"LAJ", 0x00	;OS details
